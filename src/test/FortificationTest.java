...
/**
 * This class tests the fortification controller
 * 
...
public class FortificationTest {
	...
	/**
	 * in this method objects of player and country class are created and values are
	 * passed to methods. this method will be executed before each test case
	 */
	@Before
	public void onStart() {
	...
	/**
	 * this test case will pass if their is a path between source and destination
	 * country
	 */
	@Test
	...
	/**
	 * this test case will pass if their is no path between source and destination
	 * country
	 */
	@Test
	...
	/**
	 * this method tests whether armies can be moved from source country to
	 * destination country according to the risk rules
	 */
	@Test
