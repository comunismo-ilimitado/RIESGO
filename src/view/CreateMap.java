...
public class CreateMap {
    ...
    public void AssignNeighboursFrame() {
		...
		AssignNeighboursPanel.setSize(100, 400);
		AssignNeighboursFrame.setSize(900,900);
			...
			public void actionPerformed(ActionEvent arg0) {
			 List<Country> TempCountriesObject = new ArrayList<Country>();
				...
				System.out.println("selected");
			      Continent tempc= new Continent(Integer.parseInt(ControlValueTextField.getText()),(String)ContinentsCombo.getSelectedItem());
